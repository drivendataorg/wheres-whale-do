...
MODEL_DIR = f'{MODEL_DIR}/models_eff7_r{RANDOM_STATE}_{IMG_SIZE}/tmp'
...
learn.to_fp16()
with learn.no_bar():
    learn.fit_one_cycle(30, 5e-4); torch.save(learn.model.state_dict(), f'{MODEL_DIR}/{arch}_f{FOLD}_p0.pth')
