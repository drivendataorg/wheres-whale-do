...
#         embeddings = embeddings_2017
    ...
    for qry in qry_df.itertuples():
        ...
        sims[sims < 0 ] = 0
        sims[sims > 1 ] = 1
        top1 = pd.Series(sims, index=_db_embeddings.index).sort_values(0, ascending=False).head(1)
        ...
        if only_pseudo:
            ...
            sims2[sims2 < 0 ] = 0
            sims2[sims2 > 1 ] = 1
            top1 = pd.Series(sims2, index=qry_embeddings.index).sort_values(0, ascending=False).head(1)
